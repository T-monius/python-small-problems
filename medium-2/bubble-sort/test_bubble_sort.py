...
import unittest
from bubble_sort import sort_the_bubble_way
...
class TestBubbleSort(unittest.TestCase):
    ...
    def test_a_two_element_list(self):
        ...
        two_nums = [5, 3]
        sorted_nums = sort_the_bubble_way(two_nums)
    ...
    def test_a_multiple_element_list(self):
        ...
        nums = [2, 6, 1, 4, 7]
        sorted_nums = sort_the_bubble_way(nums)
    ...
    def test_a_list_of_names(self):
        ...
        sorted_nums = sort_the_bubble_way(names)
